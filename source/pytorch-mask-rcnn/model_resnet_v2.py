...
def detection_target_layer(proposals, gt_class_ids, gt_boxes, gt_masks, config):
    ...
    # print(torch.nonzero(positive_roi_bool).size())
...
def refine_detections(rois, probs, deltas, window, config):
    ...
    # print(len(list(torch.nonzero(keep_bool).size())) == 0)
...
class Mask(nn.Module):
    def __init__(self, depth, pool_size, image_shape, num_classes):
        ...
        self.conv5_2 = nn.Conv2d(256, 256, kernel_size=1, stride=1)
        self.deconv2 = nn.ConvTranspose2d(256, 256, kernel_size=2, stride=2)
        self.conv6 = nn.Conv2d(256, num_classes, kernel_size=1, stride=1)
...
def compute_losses(rpn_match, rpn_bbox, rpn_class_logits, rpn_pred_bbox, target_class_ids, mrcnn_class_logits, target_deltas, mrcnn_bbox, target_mask, mrcnn_mask):
    ...
    # return [0, 0, 0, 0, mrcnn_mask_loss]
